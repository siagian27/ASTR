...
public class ContactDetail2 extends Activity {
	Button back;
	Button show_map;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.contactdetail2);
               ...
               public void onClick(View v) {
                   t=new Thread() {
                         public void run() {
                             ...
                             intent.putExtra("latitude", "-6.8919179");
                             intent.putExtra("longitude", "107.5845623");
